...
builder.WebHost.ConfigureKestrel(options =>
{
    ...
    options.ListenAnyIP(5031, listenOptions =>
    {
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Collection Service API v1");
...
// -----------------------------
app.MapControllers();
app.MapGet("/health", () => Results.Ok("Collection Service running"));
